...
from payment.mixins import create_transfer
from payment.models import CustomerPayment
from payment.serializers import CustomerRefundSerializer
...
def cancel_payment_task(customer_payment_id):
    try:
        customer_payment = CustomerPayment.objects.get(pk=customer_payment_id)
...
def store_customer_refund(transfer):
    ...
    serializer = CustomerRefundSerializer(data=transfer)
